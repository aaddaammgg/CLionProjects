...
int main() {
    ...
    do {
        ...
        std::cout << "Your jacket size 10 years from now will be: " << jacket(weight, height, age + 10) << "\n";
        std::cout << "Your waist size 10 years from now will be: " << waist(weight, height, age + 10) << "\n";
