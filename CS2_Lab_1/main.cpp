...
int main() {
    char repeat;
    int userInput, userGuess, cpuGuess, cpuGuessCount;
    int min = 1, max = 1000;
    int attempts = 10;
    ...
    do {
        ...
        for (int x = attempts; x > 0; x--) {
            ...
            if (x - 1 == 0) {
                std::cout << std::endl << "You lose! The amount of attempts the CPU made was: " << cpuGuessCount << std::endl;
            } else {
                std::cout << " Attempts left: " << x - 1 << std::endl;
            }
        }
